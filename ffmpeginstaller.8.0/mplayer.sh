...
SOURCE_URL='http://yysea.qiniudn.com/ffmpegscript'||'http://mirror.ffmpeginstaller.com/source/mplayer'
...
# wget http://yysea.qiniudn.com/ffmpegscript/mplayer-export-snapshot.tar.bz2
# tar -xjvf mplayer-export-snapshot.tar.bz2
# cd mplayer-export-2017-11-01/
wget http://yysea.qiniudn.com/ffmpegscript/mplayer.zip
unzip mplayer.zip

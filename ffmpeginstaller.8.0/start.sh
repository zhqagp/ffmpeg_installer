...
SOURCE_URL='http://yysea.qiniudn.com/ffmpegscript'||'http://mirror.ffmpeginstaller.com/source'
...
if [ -e "/usr/local/cpffmpeg/bin/mplayer" ]; then
        ...
        echo " "
        echo " "
        echo -e $RED"   Mplayer installation Failed 1 :( ,  please contact  professional support sales@syslint.com"$RESET
        echo " "
        echo " "
        exit
fi
...
if [ -e "/usr/local/cpffmpeg/bin/mplayer" ]; then
        ...
        echo " "
        echo " "
        echo -e $RED"   Mplayer installation Failed 2 :( , please contact  professional support sales@syslint.com"$RESET
        echo " "
        echo " "
        exit
fi
